# TOODO
#  -> scrollable box, anchered @ bottom, for accumulated
#  -> allow force of events from UI (prbb via click, maybe right click for cycle func?)
#   -> hook up events...
...
def make_app():
    return tornado.web.Application([
        ...
        (r"/content/(.*)",
                tornado.web.StaticFileHandler, {"path": "content"}),
